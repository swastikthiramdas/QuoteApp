...
class YourQuoteAdapter(val context: Context, val list: ArrayList<QuoteModel>) :
    RecyclerView.Adapter<YourQuoteAdapter.viewholder>() {
   private val db : FirebaseFirestore = FirebaseFirestore.getInstance()
    class viewholder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val delete = view.findViewById<ImageView>(R.id.yourdatadelete)

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewholder {
        val itemview =
            LayoutInflater.from(parent.context).inflate(R.layout.yourquote_view, parent, false)
    ...
    override fun onBindViewHolder(holder: viewholder, position: Int) {
        ...
        holder.delete.setOnClickListener {
            db.collection("all").document(pos.id!!).delete().addOnSuccessListener {
